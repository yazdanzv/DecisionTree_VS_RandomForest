...
def make_random_forest():
    random_forest = RandomForestClassifier(n_estimators=100, criterion='entropy', min_samples_split=5, random_state=0)
    random_forest_train_result, random_forest_test_result, estimators = cross_validation(random_forest, x_train,
                                                                                         y_train, k=5)
    # Test DataSet
    ...
    return random_forest_train_result, random_forest_test_result, test_results


def show_plot():
    number = 0
    random_forest_train_result, random_forest_test_result, test_results = make_random_forest()
    ...
    make_plot(model_name, scores[number], scores_descriptions[number],
              random_forest_train_result[train_keys[number]],
              random_forest_test_result[test_keys[number]])
